...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    sync_rst true \
    dir O \
    corename local_buffer \
    op interface \
    ports { local_buffer_address1 { O 5 vector } local_buffer_ce1 { O 1 bit } local_buffer_we1 { O 1 bit } local_buffer_d1 { O 256 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'local_buffer'"
}
}
