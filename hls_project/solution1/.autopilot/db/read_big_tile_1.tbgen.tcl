set moduleName read_big_tile_1
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {read_big_tile.1}
set C_modelType { void 0 }
set C_modelArgList {
	{ gmem1 int 256 regular {axi_master 0}  }
	{ dram_matrix int 64 regular  }
	{ local_buffer int 256 regular {array 32 { 3 0 } 0 1 }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem1", "interface" : "axi_master", "bitwidth" : 256, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "mat_B","offset": { "type": "dynamic","port_name": "mat_B","bundle": "control"},"direction": "READONLY"}]}]} , 
 	...
 	{ "Name" : "local_buffer", "interface" : "memory", "bitwidth" : 256, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ local_buffer_address1 sc_out sc_lv 5 signal 2 } 
	{ local_buffer_ce1 sc_out sc_logic 1 signal 2 } 
	{ local_buffer_we1 sc_out sc_logic 1 signal 2 } 
	{ local_buffer_d1 sc_out sc_lv 256 signal 2 } 
	{ tile_index sc_in sc_lv 27 signal 3 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "local_buffer_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "local_buffer", "role": "address1" }} , 
 	{ "name": "local_buffer_ce1", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "local_buffer", "role": "ce1" }} , 
 	{ "name": "local_buffer_we1", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "local_buffer", "role": "we1" }} , 
 	{ "name": "local_buffer_d1", "direction": "out", "datatype": "sc_lv", "bitwidth":256, "type": "signal", "bundle":{"name": "local_buffer", "role": "d1" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			{"Name" : "gmem1", "Type" : "MAXI", "Direction" : "I",
				...
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_read_big_tile_1_Pipeline_Read_Loop_fu_77", "Port" : "gmem1", "Inst_start_state" : "9", "Inst_end_state" : "10"}]},
			{"Name" : "dram_matrix", "Type" : "None", "Direction" : "I"},
			{"Name" : "local_buffer", "Type" : "Memory", "Direction" : "O",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_read_big_tile_1_Pipeline_Read_Loop_fu_77", "Port" : "local_buffer", "Inst_start_state" : "9", "Inst_end_state" : "10"}]},
			{"Name" : "tile_index", "Type" : "None", "Direction" : "I"}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_read_big_tile_1_Pipeline_Read_Loop_fu_77", "Parent" : "0", "Child" : ["2"],
	...
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_read_big_tile_1_Pipeline_Read_Loop_fu_77.flow_control_loop_pipe_sequential_init_U", "Parent" : "1"}]}
...
set Spec2ImplPortList { 
	...
	local_buffer { ap_memory {  { local_buffer_address1 MemPortADDR2 1 5 }  { local_buffer_ce1 MemPortCE2 1 1 }  { local_buffer_we1 MemPortWE2 1 1 }  { local_buffer_d1 MemPortDIN2 1 256 } } }
