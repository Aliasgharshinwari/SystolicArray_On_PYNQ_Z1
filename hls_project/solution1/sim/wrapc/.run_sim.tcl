...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "pipelined_layer_processor_ws.autotvin.dat"
	set constFileTvOut       "pipelined_layer_processor_ws.autotvout.dat"
	set constFileHdlTvIn     "pipelined_layer_processor_ws.autohdltvin.dat"
	set constFileHdlTvOut    "pipelined_layer_processor_ws.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
