...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "pipelined_layer_processor.autotvin.dat"
	set constFileTvOut       "pipelined_layer_processor.autotvout.dat"
	set constFileHdlTvIn     "pipelined_layer_processor.autohdltvin.dat"
	set constFileHdlTvOut    "pipelined_layer_processor.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
