...
//------------------------Parameter----------------------
`define TV_IN_gmem1 "../tv/cdatafile/c.pipelined_layer_processor.autotvin_gmem1.dat"
`define TV_OUT_gmem1 "../tv/rtldatafile/rtl.pipelined_layer_processor.autotvout_gmem1.dat"
 parameter gmem1_ADDR_BITWIDTH = 32'd 64;
 parameter gmem1_AWUSER_BITWIDTH = 32'd 1;
 parameter gmem1_DATA_BITWIDTH = 32'd 256;
...
parameter gmem1_C_DATA_BITWIDTH = 32'd 256;
parameter gmem1_mem_depth = 32'd 4000;
    ...
    while (1) begin
        if (FIFO_AW_req_empty === 1 || BRESP_counter == 32) begin
            ...
            if (FIFO_AW_req_ADDR_tmp/data_byte_size > gmem1_mem_depth) begin
                $display ("/home/ali/Desktop/SystolicArray/solution1/sim/verilog/AESL_axi_master_gmem1.v: Write request address %d exceed AXI master gmem1 array depth: %d",FIFO_AW_req_ADDR_tmp/data_byte_size, gmem1_mem_depth); 
                $finish;
            end
    ...
    while (1) begin
        ...
        if (FIFO_AR_req_empty) begin
            ...
            if (FIFO_AR_req_ADDR_tmp/data_byte_size > gmem1_mem_depth) begin
                $display ("/home/ali/Desktop/SystolicArray/solution1/sim/verilog/AESL_axi_master_gmem1.v: Read request address %d exceed AXI master gmem1 array depth: %d",FIFO_AR_req_ADDR_tmp/data_byte_size, gmem1_mem_depth); 
                $finish;
            end
