...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.pipelined_layer_processor.autotvin_gmem0.dat"
         "c.pipelined_layer_processor.autotvin_gmem1.dat"
         "c.pipelined_layer_processor.autotvin_mat_A.dat"
         "c.pipelined_layer_processor.autotvin_mat_B.dat"
         "c.pipelined_layer_processor.autotvin_mat_C.dat"
         "c.pipelined_layer_processor.autotvin_num_row_tiles.dat"
         "c.pipelined_layer_processor.autotvin_num_depth_tiles.dat"
         "c.pipelined_layer_processor.autotvin_num_col_tiles.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.pipelined_layer_processor.autotvout_gmem0.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
