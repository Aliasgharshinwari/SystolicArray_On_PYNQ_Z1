...
//------------------------Parameter----------------------
`define TV_IN_gmem0 "../tv/cdatafile/c.pipelined_layer_processor.autotvin_gmem0.dat"
`define TV_OUT_gmem0 "../tv/rtldatafile/rtl.pipelined_layer_processor.autotvout_gmem0.dat"
...
parameter gmem0_mem_depth = 32'd 8000;
    ...
    while (1) begin
        if (FIFO_AW_req_empty === 1 || BRESP_counter == 32) begin
            ...
            if (FIFO_AW_req_ADDR_tmp/data_byte_size > gmem0_mem_depth) begin
                $display ("/home/ali/Desktop/SystolicArray/solution1/sim/verilog/AESL_axi_master_gmem0.v: Write request address %d exceed AXI master gmem0 array depth: %d",FIFO_AW_req_ADDR_tmp/data_byte_size, gmem0_mem_depth); 
                $finish;
            end
    ...
    while (1) begin
        ...
        if (FIFO_AR_req_empty) begin
            ...
            if (FIFO_AR_req_ADDR_tmp/data_byte_size > gmem0_mem_depth) begin
                $display ("/home/ali/Desktop/SystolicArray/solution1/sim/verilog/AESL_axi_master_gmem0.v: Read request address %d exceed AXI master gmem0 array depth: %d",FIFO_AR_req_ADDR_tmp/data_byte_size, gmem0_mem_depth); 
                $finish;
            end
