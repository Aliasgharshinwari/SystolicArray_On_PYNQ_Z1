...
`define AUTOTB_DUT      pipelined_layer_processor
`define AUTOTB_DUT_INST AESL_inst_pipelined_layer_processor
`define AUTOTB_TOP      apatb_pipelined_layer_processor_top
`define AUTOTB_LAT_RESULT_FILE "pipelined_layer_processor.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "pipelined_layer_processor.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_pipelined_layer_processor_top
`define AUTOTB_MAX_ALLOW_LATENCY  15000000
`define AUTOTB_CLOCK_PERIOD_DIV2 5.00

`define AESL_DEPTH_gmem0 1
`define AESL_DEPTH_gmem1 1
`define AESL_DEPTH_mat_A 1
`define AESL_DEPTH_mat_B 1
`define AESL_DEPTH_mat_C 1
`define AESL_DEPTH_num_row_tiles 1
`define AESL_DEPTH_num_depth_tiles 1
`define AESL_DEPTH_num_col_tiles 1
...
`define AUTOTB_TVIN_gmem0_out_wrapc  "../tv/rtldatafile/rtl.pipelined_layer_processor.autotvin_gmem0.dat"
`define AUTOTB_TVIN_gmem1_out_wrapc  "../tv/rtldatafile/rtl.pipelined_layer_processor.autotvin_gmem1.dat"
`define AUTOTB_TVIN_mat_A_out_wrapc  "../tv/rtldatafile/rtl.pipelined_layer_processor.autotvin_mat_A.dat"
`define AUTOTB_TVIN_mat_B_out_wrapc  "../tv/rtldatafile/rtl.pipelined_layer_processor.autotvin_mat_B.dat"
`define AUTOTB_TVIN_mat_C_out_wrapc  "../tv/rtldatafile/rtl.pipelined_layer_processor.autotvin_mat_C.dat"
`define AUTOTB_TVIN_num_row_tiles_out_wrapc  "../tv/rtldatafile/rtl.pipelined_layer_processor.autotvin_num_row_tiles.dat"
`define AUTOTB_TVIN_num_depth_tiles_out_wrapc  "../tv/rtldatafile/rtl.pipelined_layer_processor.autotvin_num_depth_tiles.dat"
`define AUTOTB_TVIN_num_col_tiles_out_wrapc  "../tv/rtldatafile/rtl.pipelined_layer_processor.autotvin_num_col_tiles.dat"
`define AUTOTB_TVOUT_gmem0  "../tv/cdatafile/c.pipelined_layer_processor.autotvout_gmem0.dat"
`define AUTOTB_TVOUT_gmem0_out_wrapc  "../tv/rtldatafile/rtl.pipelined_layer_processor.autotvout_gmem0.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 1;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = -1;
parameter LENGTH_gmem0 = 8000;
parameter LENGTH_gmem1 = 4000;
parameter LENGTH_mat_A = 1;
parameter LENGTH_mat_B = 1;
parameter LENGTH_mat_C = 1;
parameter LENGTH_num_col_tiles = 1;
parameter LENGTH_num_depth_tiles = 1;
parameter LENGTH_num_row_tiles = 1;
...
reg end_mat_A;
reg [31:0] size_mat_A;
reg [31:0] size_mat_A_backup;
reg end_mat_B;
reg [31:0] size_mat_B;
reg [31:0] size_mat_B_backup;
reg end_mat_C;
reg [31:0] size_mat_C;
reg [31:0] size_mat_C_backup;
reg end_num_row_tiles;
reg [31:0] size_num_row_tiles;
reg [31:0] size_num_row_tiles_backup;
reg end_num_depth_tiles;
reg [31:0] size_num_depth_tiles;
reg [31:0] size_num_depth_tiles_backup;
reg end_num_col_tiles;
reg [31:0] size_num_col_tiles;
reg [31:0] size_num_col_tiles_backup;
