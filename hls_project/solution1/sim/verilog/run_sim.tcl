...
if {[file isfile pipelined_layer_processor.autotvin.dat]} {
	file delete -force pipelined_layer_processor.autotvin.dat
}

if {[file isfile pipelined_layer_processor.autotvout.dat]} {
	file delete -force pipelined_layer_processor.autotvout.dat
}
