...
`timescale 1ns/1ps
module pipelined_layer_processor_dataflow_in_loop_Depth_Loop_tile_B_V_RAM_2P_BRAM_1R1W
#(parameter
    DataWidth    = 256,
    AddressRange = 32,
    AddressWidth = 5,
...
generate
    for (i = 0; i < BufferCount; i = i + 1) begin : gen_buffer
        pipelined_layer_processor_dataflow_in_loop_Depth_Loop_tile_B_V_RAM_2P_BRAM_1R1W_memcore pipelined_layer_processor_dataflow_in_loop_Depth_Loop_tile_B_V_RAM_2P_BRAM_1R1W_memcore_U (
            .ce0      ( buf_ce0[i] ),
            .address0 ( buf_a0[i] ),
            .q0       ( buf_q0[i] ),
            .ce1      ( buf_ce1[i] ),
